  ...
  return (
    <section className="sobre-mi">
      <div className="titulo">
        <h1><span id="colorSobre">Sobre</span> <span id="colorMi">Mi</span></h1>
      </div>
      <div className="descripcion">
       <p>Desarrollador full-stack apasionado con experiencia en tecnologías web modernas y diseño.</p>
      </div>
    <div className="perfil">
      <div className="info">
      <div className="infoTitle"><h1>Quien soy?</h1></div>
